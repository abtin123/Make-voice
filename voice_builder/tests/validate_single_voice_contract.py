...
assert '"cookie": self._session_cookie' in avasho
assert '"--csrf-env"' in single and "AVASHO_CSRF_TOKEN" in single
assert '"--session-cookie-env"' in single and "AVASHO_SESSION_COOKIE" in single
...
assert "AVASHO_CSRF_TOKEN" in workflow and "AVASHO_SESSION_COOKIE" in workflow
assert 'test -n "$AVASHO_CSRF_TOKEN"' in workflow

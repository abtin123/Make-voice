...
assert "secrets.token_urlsafe(32)" in avasho
assert 'f"XSRF-TOKEN={urllib.parse.quote(self._csrf_token, safe=\'\')}"' in avasho
assert '"origin": self.base_url' in avasho and '"referer": f"{self.base_url}/"' in avasho

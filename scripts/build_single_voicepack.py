...
def build_pack(*, input_path: Path, out_dir: Path, speaker: str, speed: float,
               token: str, cache_dir: Path, csrf_token: str = "", session_cookie: str = "") -> Path:
...
def main() -> None:
    ...
    parser.add_argument("--csrf-env", default="AVASHO_CSRF_TOKEN",
                        help="نام متغیر override اختیاری CSRF برای gatewayهای غیرمتعارف")
    parser.add_argument("--session-cookie-env", default="AVASHO_SESSION_COOKIE",
                        help="نام متغیر override اختیاری کوکی نشست برای gatewayهای غیرمتعارف")
